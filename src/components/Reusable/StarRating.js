...
function StarRating(props) {
  ...
  return (
    <div className="rating">
      ...
      <span onMouseEnter={()=>handleHover(2)} onMouseLeave={()=>setRatingOnHover(null)} className={`fa star fa-star${ratingOnHover > 1?'':'-o'}`} />
      <span onMouseEnter={()=>handleHover(3)} onMouseLeave={()=>setRatingOnHover(null)} className={`fa star fa-star${ratingOnHover > 2?'':'-o'}`} />
      <span onMouseEnter={()=>handleHover(4)} onMouseLeave={()=>setRatingOnHover(null)} className={`fa star fa-star${ratingOnHover > 3?'':'-o'}`} />
      <span onMouseEnter={()=>handleHover(5)} onMouseLeave={()=>setRatingOnHover(null)} className={`fa star fa-star${ratingOnHover > 4?'':'-o'}`} />
