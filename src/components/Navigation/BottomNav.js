...
const BottomNav = () => {
  return (
    <div className="nav">
      <div className="item">
        <NavLink to="/locations" activeClassName="active-link active2">
          <div>
            <img
              src="https://icon-library.com/images/icon-for-laptop/icon-for-laptop-18.jpg"
              alt="Locations"
              height="50px"
              width="50px"
            />
      ...
      <div className="item">
        <NavLink to="/invite" activeClassName="active-link active2">
          <div>
            <img
      ...
      <div className="item">
        <NavLink exact to="/" activeClassName="active-link active2">
          <div>
            <img
      ...
      <div className="item">
        <NavLink to="/profile" activeClassName="active-link active2">
          <div>
            <img
      ...
      <div className="item">
        <div style={{ height: "50px", width: "80px" }}>
          <h1 style={{ color: "rgb(26, 26, 26)" }}>............</h1>
          <LiveChat />
        </div>
      </div>
    </div>
